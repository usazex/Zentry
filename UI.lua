...
function UI.createLayout(widgetInstance)
	...
	inputBox.TextYAlignment = Enum.TextYAlignment.Top -- Align text to top for better scrolling/visibility
	inputBox.ClipsDescendants = true -- Helps ensure scrollbar appears correctly if text overflows
